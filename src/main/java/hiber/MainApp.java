...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      User user1 = new User("User1", "Lastname1", "user1@mail.ru",new Car("m1",1));
      userService.add(user1);
      User user2 = new User("User2", "Lastname2", "user2@mail.ru",new Car("m2",2));
      userService.add(user2);
      User user3 = new User("User3", "Lastname3", "user3@mail.ru",new Car("m3",3));
      userService.add(user3);
      User user4 = new User("User4", "Lastname4", "user4@mail.ru",new Car("m4",4));
